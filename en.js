const en = {
	...
	community: {
		...
		uploading: "Uploading",
		loading_posts: "Loading more posts",
		no_posts: "No more posts to load",
		failed_posts: "Failed to load posts",
		loading_post: "Loading posts",
		no_post: "No Post yet",
		...
		upload: {
			...
			parameters: "Configure Acquisition Parameters",
			total_time: "Total time",
			integration_time: "Total Integration Time",
			number_frames: "Number of Frames",
			filter_integration_time: "Integration time for this filter",
			edit_post: "Edit Post",
			post: "Post",
			create_post: "Create Post",
			original_image: "Original Image",
			post_title: "Enter post title",
			description: "Describe your astrophotography",
	...
	connect: {
		...
		oauth_legacy_device_error:
			"This StellarMate device requires a password to connect. Please log out and sign in with your username and password, or update your StellarMate to the latest version.",
	...
	ekos: {
		...
		collapse_camera: {
			...
			info_note_body: "Pick a preset, specify the number of frames to capture, then tap Add Sequence to queue it. Tap Start when your queue is ready.",
		...
		collapse_sequence: {
			...
			sequences: "Sequences",
			no_sequences: "No Sequences in the queue",
		...
		scheduler: {
			...
			info_note_title: "Ready to schedule",
			info_note_body: "Select a target and sequence file, then tap Add Job to queue it. You can also pick a target from the Sky or Targets tab.",
	...
	controller: {
		...
		active_gps_antenna: "Active GPS Antenna",
		...
		auto_dew: "Auto Dew",
		auto_dew1_threshold: "Dew 1 Threshold",
		auto_dew2_threshold: "Dew 2 Threshold",
		stepper: "Stepper",
		buzzer: "Buzzer",
		sensors: "Sensors",
	...
	postprocessing: {
		...
		calib_mode_folder: "Folder",
		calib_mode_master: "Master",
		calib_mode_none: "None",
		calib_select_folder: "Select Folder",
		calib_select_file: "Select Master File",
		calib_select_light_file: "Select File",
		calib_no_folder: "No folder selected",
		calib_no_master: "No master file selected",
		calib_no_file: "No file selected",
		calib_section_calibration: "Calibration frames",
		calib_section_source: "Source",
		calib_source_file: "File",
		calib_source_folder: "Folder",
		flat_variant_single: "Single",
		flat_variant_per_filter: "Per Filter",
		calib_status_not_used: "Not used",
		calib_no_filters: "No filters set",
		calib_filters_set: "{0} filters set",
		calib_filter_placeholder: "Filter",
		calib_folder_frames_count: "{0} frames",
		calib_folder_auto_master: "We'll build a master from these frames automatically.",
		calib_match_exptime: "Match Exposure (s)",
		calib_match_exptime_placeholder: "blank = use all files",
		calib_exptime_tolerance: "Tolerance (s)",
		master_sigma_low: "Master Low σ",
		master_sigma_high: "Master High σ",
		inspect_title: "Folder Contents",
		inspect_file_count: "{0} FITS files found",
		inspect_count: "{0} files",
		inspect_use: "Use",
		inspect_failed_title: "Failed to inspect folder",
		calib_flat_single_hint:
			"Use one flat for every filter - fine if your optical train doesn't change between filters.",
		calib_flat_per_filter_hint:
			"Use a different flat for each filter - recommended when your optical train changes between filters.",
		calib_lights_per_filter_hint:
			"Use a different light source for each filter.",
		btn_add_filter: "Add Filter",
		frame_light: "Lights",
		frame_flat: "Flats",
		frame_dark: "Darks",
		frame_bias: "Bias",
		no_lights_selected: "At least one light frame is required.",
		step_calibrate: "Calibrate",
		step_stack: "Stack",
		step_combine: "Combine",
		step_crop: "Crop",
		step_bge: "Background Extraction",
		step_colorcal: "Color Calibration",
		colorcal_result: "{0} stars detected, {1} corrected",
		step_denoise: "Denoise",
		step_stretch: "Stretch",
		step_saturation: "Saturation",
		step_contrast: "Contrast",
		step_calibrate_short: "Calibrate",
		step_stack_short: "Stack",
		step_combine_short: "Combine",
		step_crop_short: "Crop",
		step_bge_short: "BGE",
		step_colorcal_short: "Color",
		step_denoise_short: "Denoise",
		step_stretch_short: "Stretch",
		step_saturation_short: "Saturation",
		step_contrast_short: "Contrast",
		btn_run: "Run",
		btn_redo: "Redo",
		btn_undo: "Undo",
		btn_skip: "Skip",
		...
		reset_step: "Restore this step's defaults",
		confirm_defaults_title: "Restore Defaults?",
		confirm_defaults_body: "This step's settings go back to their defaults — including the folders and masters you picked.",
		...
		stack_reject_trails: "Trails",
		stack_max_elongation: "max elong",
		stack_no_align_master: "No align master selected",
		stack_unaligned_warning: "Stacked without alignment — no sub could be plate-solved, so subs were combined at their raw pixel position. Stars may look smeared from ordinary tracking drift.",
		stack_postprocess_toggle: "Pre-combine Post-Processing",
		stack_gradient_amt: "gradient",
		stack_denoise_amt: "denoise",
		stack_chroma_denoise_amt: "chroma",
		stack_deconv_amt: "deconvolve",
		stack_psf_sigma: "PSF σ",
		stack_sharpen_amt: "sharpen",
		stack_sharpen_kernel: "kernel",
		stack_sharpen_sigma: "sharpen σ",
		btn_redo_postprocess: "Redo Post-Process",
		redo_postprocess_failed_title: "Failed to redo post-processing",
		step_failed_title: "Step failed",
		step_failed_body: "An error occurred while running {0}: {1}",
		crop_requires_values: "Enter a crop width and height greater than 0, or skip this step.",
		curve_requires_points: "Enter at least 2 points for the curve, or skip this step.",
		combine_requires_channels: "Assign at least one filter or master file to Red, Green and Blue before combining.",
		combine_no_filters_hint: "No stacked filters yet — add filters under Lights (Per Filter) and stack them before combining, or pick a saved master file instead.",
		combine_mode_session: "Stacked",
		combine_mode_file: "File",
		combine_no_master_file: "No master file selected",
		combine_select_master_file: "Select Master File",
		step_out_of_order: "Run \"{0}\" first (or skip it) — steps must run in pipeline order.",
		...
		crop_roi_label: "Drag to select region",
		undo_failed_title: "Failed to undo",
		confirm_cancel_title: "Cancel post-processing?",
		confirm_cancel_body: "The current job will be stopped and its temporary files removed.",
	},
	wizard: {
