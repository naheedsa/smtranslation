const ja = {
	...
	postprocessing: {
		heading: "後処理",
		calib_mode_folder: "フォルダ",
		calib_mode_master: "マスター",
		calib_mode_none: "なし",
		calib_select_folder: "フォルダを選択",
		calib_select_file: "マスターファイルを選択",
		calib_select_light_file: "ファイルを選択",
		calib_no_folder: "フォルダが選択されていません",
		calib_no_master: "マスターファイルが選択されていません",
		calib_no_file: "ファイルが選択されていません",
		calib_section_calibration: "キャリブレーションフレーム",
		calib_section_source: "ソース",
		calib_source_file: "ファイル",
		calib_source_folder: "フォルダ",
		flat_variant_single: "単一",
		flat_variant_per_filter: "フィルターごと",
		calib_status_not_used: "未使用",
		calib_no_filters: "フィルターが設定されていません",
		calib_filters_set: "{0} 個のフィルターを設定済み",
		calib_filter_placeholder: "フィルター",
		calib_folder_frames_count: "{0} フレーム",
		calib_folder_auto_master: "これらのフレームから自動的にマスターを作成します。",
		calib_match_exptime: "露出を一致させる (秒)",
		calib_match_exptime_placeholder: "空白 = すべてのファイルを使用",
		calib_exptime_tolerance: "許容範囲 (秒)",
		master_sigma_low: "マスター Low σ",
		master_sigma_high: "マスター High σ",
		inspect_title: "フォルダの内容",
		inspect_file_count: "{0} 個の FITS ファイルが見つかりました",
		inspect_count: "{0} 個のファイル",
		inspect_use: "使用",
		inspect_failed_title: "フォルダの検査に失敗しました",
		calib_flat_single_hint:
			"すべてのフィルターに1枚のフラットを使用します。光学系がフィルター間で変化しない場合に適しています。",
		calib_flat_per_filter_hint:
			"フィルターごとに異なるフラットを使用します。光学系がフィルター間で変化する場合に推奨されます。",
		calib_lights_per_filter_hint:
			"フィルターごとに異なるライトソースを使用します。",
		btn_add_filter: "フィルターを追加",
		frame_light: "ライト",
		frame_flat: "フラット",
		frame_dark: "ダーク",
		frame_bias: "バイアス",
		no_lights_selected: "少なくとも1枚のライトフレームが必要です。",
		step_calibrate: "キャリブレーション",
		step_stack: "スタック",
		step_combine: "合成",
		step_crop: "トリミング",
		step_bge: "背景抽出",
		step_colorcal: "カラーキャリブレーション",
		colorcal_result: "{0} 個の星を検出、{1} 個を補正",
		step_denoise: "ノイズ除去",
		step_stretch: "ストレッチ",
		step_saturation: "飽和",
		step_contrast: "コントラスト",
		step_calibrate_short: "キャリブレーション",
		step_stack_short: "スタック",
		step_combine_short: "合成",
		step_crop_short: "トリミング",
		step_bge_short: "BGE",
		step_colorcal_short: "カラー",
		step_denoise_short: "ノイズ除去",
		step_stretch_short: "ストレッチ",
		step_saturation_short: "飽和",
		step_contrast_short: "コントラスト",
		btn_run: "実行",
		btn_redo: "やり直し",
		btn_undo: "元に戻す",
		btn_skip: "スキップ",
		...
		method: "方法",
		btn_defaults: "既定値",
		reset_step: "このステップの既定値に戻す",
		confirm_defaults_title: "既定値に戻しますか？",
		confirm_defaults_body: "このステップの設定が既定値に戻ります。選択したフォルダーやマスターファイルも含まれます。",
		status_pending: "保留中",
		status_running: "実行中…",
		status_completed: "完了",
		...
		channel_green: "緑",
		channel_blue: "青",
		stack_hot_pixels: "ホットピクセル",
		stack_cold_pixels: "コールドピクセル",
		stack_reject_trails: "軌跡",
		stack_max_elongation: "最大伸長",
		stack_no_align_master: "位置合わせ用マスターが選択されていません",
		stack_unaligned_warning: "位置合わせなしでスタックしました。プレートソルブできたサブフレームがなかったため、各サブフレームは元のピクセル位置のまま合成されています。通常の追尾ドリフトにより星が流れて見えることがあります。",
		stack_postprocess_toggle: "合成前の後処理",
		stack_gradient_amt: "グラデーション",
		stack_denoise_amt: "ノイズ除去",
		stack_chroma_denoise_amt: "色ノイズ",
		stack_deconv_amt: "デコンボリューション",
		stack_psf_sigma: "PSF σ",
		stack_sharpen_amt: "シャープ化",
		stack_sharpen_kernel: "カーネル",
		stack_sharpen_sigma: "シャープ化 σ",
		btn_redo_postprocess: "後処理をやり直す",
		redo_postprocess_failed_title: "後処理のやり直しに失敗しました",
		step_failed_title: "ステップが失敗しました",
		step_failed_body: "{0} の実行中にエラーが発生しました: {1}",
		crop_requires_values: "0より大きいトリミングの幅と高さを入力するか、このステップをスキップしてください。",
		curve_requires_points: "カーブに少なくとも2つのポイントを入力するか、このステップをスキップしてください。",
		combine_requires_channels: "合成する前に、赤・緑・青のそれぞれに少なくとも1つのフィルターまたはマスターファイルを割り当ててください。",
		combine_no_filters_hint: "スタック済みのフィルターがまだありません。ライト（フィルターごと）でフィルターを追加してスタックするか、保存済みのマスターファイルを選択してください。",
		combine_mode_session: "スタック済み",
		combine_mode_file: "ファイル",
		combine_no_master_file: "マスターファイルが選択されていません",
		combine_select_master_file: "マスターファイルを選択",
		step_out_of_order: "先に「{0}」を実行してください（またはスキップしてください）— ステップはパイプラインの順序で実行する必要があります。",
		...
		crop_roi_label: "ドラッグして範囲を選択",
		undo_failed_title: "元に戻す操作に失敗しました",
		confirm_cancel_title: "後処理をキャンセルしますか？",
		confirm_cancel_body: "現在のジョブは停止され、一時ファイルは削除されます。",
	},
	wizard: {
