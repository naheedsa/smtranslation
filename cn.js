﻿const cn = {
	...
	tooltip: {
		...
		dec_backlash: "校准导星时消除赤纬齿隙的影响",
		reset_calibration: "如果勾选，每次开始导星时都会重新校准。当之前已完成高质量校准且导星相机未重新安装时，通常无需重新校准。",
		reverse_pierside: "重新使用校准时，如果当前镜筒侧与校准时不同，则反转赤纬角度。此选项仅适用于重新使用校准的情况。所需的值是您赤道仪的固有属性，应事先查阅相关资料。",
		reuse_calibration: "存储并尝试重新使用校准数据。如果能从赤道仪自动判断镜筒侧，此功能甚至可在子午线两侧正常工作。",
		guide_manual: "如果您希望重新使用导星校准，但没有旋转器设备且导星相机随摄像相机手动旋转（例如使用离轴导星系统），请勾选此选项。请注意，旋转器设置中的 自动和手动旋转器控制 选项处于激活状态是前提条件。",
		pulse_dither: "如果勾选，抖动量将随机生成，脉冲信号会被发送，但不会强制执行像素抖动量，因此仅发送一次抖动脉冲。此方式速度更快，且由于抖动量本身是随机的，建议使用此选项。当需要二维抖动但导星仅在单轴进行时，此选项是必要的。",
		abort_autoguide: "如果勾选，当抖动失败时将中止自动导星。否则，导星将正常恢复。",
	...
	ekos: {
		...
		collapse_camera: {
			...
			info_note_body: "选择一个预设，指定要拍摄的帧数，然后点击添加序列以将其加入队列。队列准备好后点击开始。",
			...
			filterOffset: { title: "构建滤镜偏移量", focusRuns: "对焦运行", reference: "参考" }
		},
		capture_presets: {
			heading: "预设设置",
		},
		...
		scheduler: {
			...
			no_jobs: "队列中没有任务",
			info_note_title: "准备排程",
			info_note_body: "选择目标和序列文件，然后点击添加任务将其加入队列。您也可以从天空或目标标签页选择目标。",
	...
	status: {
		...
		alert_forget_password_description: "请输入您的电子邮件或用户名，我们将向您发送重置密码的链接。",
	...
	cloud: {
		...
		enable_cloud: "要开始捕获序列图像，请在设置中启用EkosLive云上传。",
	...
	postprocessing: {
		heading: "后期处理",
		calib_mode_folder: "文件夹",
		calib_mode_master: "主帧",
		calib_mode_none: "无",
		calib_select_folder: "选择文件夹",
		calib_select_file: "选择主帧文件",
		calib_select_light_file: "选择文件",
		calib_no_folder: "未选择文件夹",
		calib_no_master: "未选择主帧文件",
		calib_no_file: "未选择文件",
		calib_section_calibration: "校准帧",
		calib_section_source: "来源",
		calib_source_file: "文件",
		calib_source_folder: "文件夹",
		flat_variant_single: "单一",
		flat_variant_per_filter: "按滤镜",
		calib_status_not_used: "未使用",
		calib_no_filters: "未设置滤镜",
		calib_filters_set: "已设置 {0} 个滤镜",
		calib_filter_placeholder: "滤镜",
		calib_folder_frames_count: "{0} 帧",
		calib_folder_auto_master: "我们会自动使用这些帧生成主帧。",
		calib_match_exptime: "匹配曝光时间（秒）",
		calib_match_exptime_placeholder: "留空 = 使用所有文件",
		calib_exptime_tolerance: "容差（秒）",
		master_sigma_low: "主帧低 σ",
		master_sigma_high: "主帧高 σ",
		inspect_title: "文件夹内容",
		inspect_file_count: "找到 {0} 个 FITS 文件",
		inspect_count: "{0} 个文件",
		inspect_use: "使用",
		inspect_failed_title: "检查文件夹失败",
		calib_flat_single_hint:
			"为所有滤镜使用同一张平场——如果您的光路在切换滤镜时不会改变，这样做没有问题。",
		calib_flat_per_filter_hint:
			"为每个滤镜使用不同的平场——建议在光路会随滤镜切换而改变时使用。",
		...
		step_bge: "背景提取",
		step_colorcal: "色彩校准",
		colorcal_result: "检测到 {0} 颗星，已校正 {1} 颗",
		step_denoise: "降噪",
		step_stretch: "拉伸",
		step_saturation: "饱和度",
		step_contrast: "对比度",
		step_calibrate_short: "校准",
		step_stack_short: "叠加",
		step_combine_short: "合成",
		step_crop_short: "裁剪",
		step_bge_short: "BGE",
		step_colorcal_short: "色彩",
		step_denoise_short: "降噪",
		step_stretch_short: "拉伸",
		step_saturation_short: "饱和度",
		step_contrast_short: "对比度",
		btn_run: "运行",
		btn_redo: "重做",
		btn_undo: "撤销",
		btn_skip: "跳过",
		...
		method: "方法",
		btn_defaults: "默认值",
		reset_step: "恢复此步骤的默认设置",
		confirm_defaults_title: "恢复默认设置？",
		confirm_defaults_body: "此步骤的设置将恢复为默认值，包括您所选择的文件夹和主帧文件。",
		status_pending: "等待中",
		status_running: "运行中…",
		status_completed: "完成",
		status_skipped: "已跳过",
		...
		channel_green: "绿",
		channel_blue: "蓝",
		stack_hot_pixels: "热像素",
		stack_cold_pixels: "冷像素",
		stack_reject_trails: "拖尾",
		stack_max_elongation: "最大拉长",
		stack_no_align_master: "未选择对齐主帧",
		stack_unaligned_warning: "未经对齐即完成叠加——没有任何子帧能够完成板面解析，因此各子帧按原始像素位置合成。受常规跟踪漂移影响，星点可能出现拖影。",
		stack_postprocess_toggle: "合成前后期处理",
		stack_gradient_amt: "渐变",
		stack_denoise_amt: "降噪",
		stack_chroma_denoise_amt: "色度",
		stack_deconv_amt: "去卷积",
		stack_psf_sigma: "PSF σ",
		stack_sharpen_amt: "锐化",
		stack_sharpen_kernel: "核",
		stack_sharpen_sigma: "锐化 σ",
		btn_redo_postprocess: "重做后期处理",
		redo_postprocess_failed_title: "重做后期处理失败",
		step_failed_title: "步骤失败",
		step_failed_body: "运行 {0} 时发生错误：{1}",
		crop_requires_values: "请输入大于 0 的裁剪宽度和高度，或跳过此步骤。",
		curve_requires_points: "请为曲线输入至少 2 个点，或跳过此步骤。",
		combine_requires_channels: "合成前请为红、绿、蓝各分配至少一个滤镜或主帧文件。",
		combine_no_filters_hint: "尚无已叠加的滤镜——请在“亮场（按滤镜）”中添加滤镜并先完成叠加，或改为选择已保存的主帧文件。",
		combine_mode_session: "已叠加",
		combine_mode_file: "文件",
		combine_no_master_file: "未选择主帧文件",
		combine_select_master_file: "选择主帧文件",
		step_out_of_order: "请先运行“{0}”（或跳过它）—— 步骤必须按流程顺序执行。",
		...
		crop_roi_label: "拖动以选择区域",
		undo_failed_title: "撤销失败",
		confirm_cancel_title: "取消后期处理？",
		confirm_cancel_body: "当前任务将被停止，其临时文件也将被删除。",
	},
	wizard: {
